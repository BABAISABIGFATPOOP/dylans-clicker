...
- For major updates (new features, big changes): bump the middle number and reset patch to 0 (e.g. 1.2.1 → 1.3.0)
- For minor updates (small fixes, text changes): bump the last number (e.g. 1.2.1 → 1.2.2)
